    ...
    <section className="container mx-auto">
      <div className="flex flex-col justify-center items-center h-main">
        ...
        <div className="mt-6 md:mt-8 flex gap-4">
          <button
            className="bg-zinc-950 lg:hover:bg-zinc-700 text-white h-fit py-[5px] md:py-2 px-4 rounded"
            onClick={() => router.push("/")}
          >
            Home
          </button>
          <button
            className="bg-slate-600 lg:hover:bg-slate-700 text-white h-fit py-[5px] md:py-2 py-2 px-4 rounded"
            onClick={() => router.back()}
          >
            Go Back
          </button>
